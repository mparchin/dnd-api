...
{
    [DbContext(typeof(Db))]
    [Migration("20240813140453_RaceAndBackgroundMigration")]
    partial class RaceAndBackgroundMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.Background", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("api.Models.CharacterAttack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("CustomSaveDC")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("api.Models.CharacterItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("NeedsAttunment")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("api.Models.CharacterSpellCasting", b =>
                {
                    ...
                    b.Property<bool>("Used6thLevel")
                        .HasColumnType("boolean");

                    b.Property<bool>("Used7thLevel")
                        .HasColumnType("boolean");

                    b.Property<bool>("Used8thLevel")
                        .HasColumnType("boolean");

                    b.Property<bool>("Used9thLevel")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("api.Models.ItemEffect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("api.Models.ItemEffect", b =>
                {
                    b.HasOne("api.Models.CharacterItem", "Item")
                        .WithMany("Effects")
